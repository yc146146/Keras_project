...
# 评估：loss: 0.3627143634539662 准确率：acc: 0.8645583450110443 100
...
data_ck_list = pd.read_csv("../data/python_ck_new.csv",encoding="gbk")
...
# 定义数据加载器
all_datas = Data.DataLoader(dataset = dataset, batch_size = batch_size, shuffle = False)
...
mdoel_fit(100, all_datas, model, total_len)
