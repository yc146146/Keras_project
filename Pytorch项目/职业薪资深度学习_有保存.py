...
data_list = pd.read_csv("../data/python_12_no0_new.csv",encoding="gbk")
...
mdoel_fit(200, all_datas, model, total_len)
...
#保存
torch.save(model, './cp/net.pkl')

#读取模型
model2 = torch.load("./cp/net.pkl")
