...
# 测试数据
x_test1 = np.random.randint(0, 99, (100, 1))
x_test2 = np.random.randint(100, 999, (100, 1))
x_test3 = np.random.randint(1000, 9999, (100, 1))
x_test4 = np.random.randint(10000, 99999, (100, 1))
...
layer1 = tf.layers.dense(inputs=X, units=16, activation=tf.nn.tanh, kernel_initializer=tf.random_normal_initializer(
    mean=0, stddev=0.1), bias_initializer=tf.constant_initializer(0), name=LAYER_1_NAME)
layer2 = tf.layers.dense(inputs=layer1, units=4, activation=tf.nn.softmax, kernel_initializer=tf.random_normal_initializer(
...
with tf.Session() as sess:
    ...
    print("predict", predict.eval(feed_dict={X: [[15.], [440.], [9990.], [66660.]]}))
