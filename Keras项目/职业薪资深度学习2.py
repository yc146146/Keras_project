...
ada = optimizers.Adam(lr=0.005, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
model.fit(x_train, y_train, batch_size=2048, epochs=10, shuffle=True)
